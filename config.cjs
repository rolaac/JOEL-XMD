...
const config = {
  SESSION_ID: process.env.SESSION_ID || "JOEL~XMD~MdW7VnYc",
  PREFIX: process.env.PREFIX || '.',
//let's add menu captions by lord joel
   BOT_NAME: process.env.BOT_NAME || "Mr Zohaib ",
...
// don't use my codes without a permission 🙏
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "03173294975",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "03173294975",
